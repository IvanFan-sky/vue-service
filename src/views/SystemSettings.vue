...
const loadConfigs = async () => {
  try {
    const response = await apiClient.get('/api/system/configs')
...
const handleSaveAll = async () => {
  try {
    ...
    await apiClient.post('/api/system/configs', { configs })
...
const handleTestEmail = async () => {
  ...
  try {
    ...
    await apiClient.post('/api/system/test-email', emailConfig)
...
const handleTestStorage = async () => {
  try {
    ...
    await apiClient.post('/api/system/test-storage', storageConfig)
