    ...
    <div class="profile-header">
      <div class="header-content">
        <div class="user-avatar">
          <el-avatar :size="120" :src="userInfo?.avatar" :icon="UserFilled" class="avatar-image" />
          <el-button
            type="primary"
            size="small"
            class="avatar-upload"
          ...
          <el-card class="info-card" shadow="never">
            <template #header>
              <div class="card-header">
                <h3>基本信息</h3>
                <el-button type="primary" size="small" @click="handleEdit" :disabled="editing">
                  {{ editing ? '编辑中...' : '编辑信息' }}
                </el-button>
              </div>
            </template>
...
<script setup lang="ts">
  ...
  const maskEmail = (email: string) => {
    ...
    const maskedUsername =
      username.length > 3 ? username.slice(0, 2) + '***' + username.slice(-1) : username
