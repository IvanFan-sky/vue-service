      ...
      <el-row :gutter="20">
        <el-col :span="8">
          <el-form-item :label="t('userManagement.form.role')" prop="role">
            <el-select v-model="formData.role" :placeholder="t('userManagement.form.rolePlaceholder')">
              <el-option
        ...
        <el-col :span="8">
          <el-form-item :label="t('userManagement.form.status')" prop="status">
            <el-select v-model="formData.status" :placeholder="t('userManagement.form.statusPlaceholder')">
              <el-option
        ...
        <el-col :span="8">
          <el-form-item :label="t('userManagement.form.gender')" prop="gender">
            <el-select v-model="formData.gender" :placeholder="t('userManagement.form.genderPlaceholder')">
              <el-option
...
const formRules = computed(() => ({
  username: [
    ...
    { pattern: /^[a-zA-Z0-9_]+$/, message: t('userManagement.validation.usernameFormat'), trigger: 'blur' }
  ],
  realName: [
  ...
  phone: [
    ...
    { pattern: /^1[3-9]\d{9}$/, message: t('userManagement.validation.phoneFormat'), trigger: 'blur' }
  ],
  password: props.mode === 'create' ? [
    { required: true, message: t('userManagement.validation.passwordRequired'), trigger: 'blur' },
    { min: 6, max: 20, message: t('userManagement.validation.passwordLength'), trigger: 'blur' }
  ] : [],
  confirmPassword: props.mode === 'create' ? [
    { required: true, message: t('userManagement.validation.confirmPasswordRequired'), trigger: 'blur' },
  ...
  age: [
    ...
    { type: 'number', min: 18, max: 100, message: t('userManagement.validation.ageRange'), trigger: 'blur' }
  ],
  department: [
    { required: true, message: t('userManagement.validation.departmentRequired'), trigger: 'change' }
  ],
  position: [
    { required: true, message: t('userManagement.validation.positionRequired'), trigger: 'change' }
  ],
  address: [
...
const handleSubmit = async () => {
  ...
  try {
    ...
    ElMessage.error(props.mode === 'create' ? t('userManagement.createError') : t('userManagement.updateError'))
