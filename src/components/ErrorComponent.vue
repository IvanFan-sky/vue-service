  ...
  <div class="error-component" :class="{ 'error-component--dark': isDark }">
    <div class="error-content">
      ...
      <div class="error-actions">
        <el-button type="primary" @click="handleRetry" :loading="retrying" v-if="showRetry">
          {{ retrying ? '重试中...' : '重试' }}
        </el-button>

        <el-button @click="handleGoBack" v-if="showGoBack"> 返回上页 </el-button>

        <el-button @click="handleGoHome" v-if="showGoHome"> 返回首页 </el-button>

        <el-button @click="handleReport" type="info" plain v-if="showReport"> 报告问题 </el-button>
      </div>
    </div>
  </div>
</template>
